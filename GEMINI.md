...
- **Stable RunPod Proxy (v2.2.1)**: Always use the RunPod HTTP Proxy URL (e.g., `https://73atszmbozf16d-8000.proxy.runpod.net`) for `VITE_API_URL` to prevent "Offline" errors caused by IP changes.
